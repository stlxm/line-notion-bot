...
FEATURES = [
    {
        "name": "予算設定",
        "status": "implemented",
        "aliases": ["予算", "月予算", "全体予算", "毎月1日予算", "ジャンル予算"],
        "usage": "「予算 100000」「予算 お菓子 3000」「予算 2026-10 食費 35000」が使えます。ジャンル別予算列がなければ月別管理DBへ自動追加します。",
    },
    {
        "name": "家計簿入力",
        "status": "implemented",
    ...
    },
    {
        ...
        "usage": "「今日サミットで2380円使った」「昨日コンビニで540円買った」のように送れます。足りないジャンル・支払方法はボタンで確認してから登録します。",
    },
    {
        "name": "よく使う支出テンプレート",
        "status": "implemented",
        "aliases": ["支出テンプレート", "支出テンプレ", "よく使う支出", "家計簿テンプレート"],
        "usage": "「支出テンプレート」と送ると、直近90日の家計簿からよく使う店・分類・支払方法を自動で候補化します。",
    },
    {
        "name": "本日のレポート",
        "status": "implemented",
        "aliases": ["今日のレポート", "日次レポート", "本日レポート"],
        "usage": "「本日のレポート」で今日の支出、内訳、最大支出、今月累計、残り予算、カード未処理を確認できます。",
    },
    {
        "name": "直前登録の修正・取り消し",
        "status": "implemented",
...
CURRENT_CAPABILITIES = [
    "今月の家計簿ダッシュボード",
    "支出登録（支出 金額 店名）",
    "自然文家計簿入力（例: 今日サミットで2380円使った）",
    "直近90日の支出からよく使う支出テンプレートを自動生成",
    "本日の支出・内訳・今月残り予算・カード未処理の日次レポート",
    "直前登録の確認・金額/店名/日付/ジャンル/支払方法の修正・取り消し",
    "全体予算・ジャンル予算設定（ジャンル予算列の自動追加）",
    "毎月1日の予算設定案内",
    "今日使える額",
    "支出ペース判定",
    "異常支出検知",
