...
2026-09-12の実機ログで残っていた次のような表記揺れが、通知上で1件へまとまることを確認します。

```text
なす / 埼玉県産ほかなす
熊本県産ほか 豊の赤ミニトマト / 福島県産ほかミニトマト
サーモンタラト (刺身用) / サーモントラウト刺身用
国内産豚かたロース 切り落とし / 国内産豚かたロース切りおとし
```
